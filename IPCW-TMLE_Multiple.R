...
for(iter in 1:1000){
  ...
  # Model_Data <- data.frame(Full_AD$W1_bar,Full_AD$W2_bar,Full_AD$A1_bar,Full_AD$A2_bar,Full_AD$A3,Full_AD$Y_bar)
  ...
  TMLE_Stage2_BothCorrect_Medication1[iter] <- sum(TMLE_Stage2_BothCorrect)
  TMLE_Stage2_CorrectG_Medication1[iter] <- sum(TMLE_Stage2_Correct_G)
  TMLE_Stage2_CorrectQ_Medication1[iter] <- sum(TMLE_Stage2_Correct_Q)
  TMLE_Stage2_BothIncorrect_Medication1[iter] <- sum(TMLE_Stage2_BothInorrect)
  #################################################################################
  print(iter)
}
